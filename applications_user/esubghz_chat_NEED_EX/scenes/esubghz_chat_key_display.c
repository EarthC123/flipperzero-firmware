...
{
	FURI_LOG_I(APPLICATION_NAME, "scene_on_enter_key_display");
...
{
	FURI_LOG_I(APPLICATION_NAME, "scene_on_event_key_display");
...
{
	FURI_LOG_I(APPLICATION_NAME, "scene_on_exit_key_display");
